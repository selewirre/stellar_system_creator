...
class BasicDetailsDialog(QDialog):
    ...
    def __init__(self, parent_item):
        from ..standard_items import TreeViewItemFromSolarSystemElement
        self.parent_item: TreeViewItemFromSolarSystemElement = parent_item
    ...
    def _set_check_boxes(self):
        sse: Union[StellarBody, Star, Planet, AsteroidBelt,
                   Satellite, Trojans] = self.parent_item.solar_system_element
    ...
    def accept(self) -> None:
        ...
        self.parent_item.set_solar_system_element_icon()
        super().accept()
    ...
    def return_texts_to_initial_values(self) -> None:
        ...
        self.parent_item.solar_system_element.__post_init__()
