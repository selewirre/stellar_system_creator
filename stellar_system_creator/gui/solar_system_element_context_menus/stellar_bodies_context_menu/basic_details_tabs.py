...
from stellar_system_creator.gui.solar_system_element_context_menus.stellar_bodies_context_menu.detail_dialog_widgets import Tab, \
...
from stellar_system_creator.solar_system_elements.stellar_body import Star, Planet, Satellite
