...
from stellar_system_creator.solar_system_elements.stellar_body import Planet, Planet, TrojanSatellite, Satellite, \
    Trojans, AsteroidBelt
...
class PlanetDetailsDialog(BasicDetailsDialog):
    ...
    def _set_other_edits(self):
        sse: Planet = self.parent_item.solar_system_element
    ...
    def _set_orbital_characteristics_tab(self):
        ...
        keys = ['Semi-Major Axis Minimum Limit', 'Semi-Major Axis Maximum Limit', 'Semi-Minor Axis', 'Apoapsis', 'Periapsis']
        ...
        self.add_keys_to_layout(orbital_stability_characteristics_box_layout, self.labels, keys)
        ...
        self.add_keys_to_layout(orientation_characteristics_box_layout, self.ule, keys)
    ...
    def _set_surface_characteristics_tab(self):
        ...
        self.add_keys_to_layout(temperature_characteristics_box_layout, self.le, keys)
        keys = ['Incident Flux', 'Temperature']
        self.add_keys_to_layout(temperature_characteristics_box_layout, self.ulabels, keys)
        ...
        self.add_keys_to_layout(gravity_characteristics_box_layout, self.ulabels, keys)
        ...
        self.add_keys_to_layout(internal_heating_characteristics_box_layout, self.ulabels, keys)
        ...
        self.add_keys_to_layout(tidal_characteristics_box_layout, self.ulabels, keys)
    ...
    def _set_miscellaneous_tab(self):
        ...
        self.add_keys_to_layout(relative_size_box_layout, self.ulabels, keys)
    ...
    def confirm_other_edit_changes(self):
        self.other_edit_init_values['Composition Type'] = self.parent_item.solar_system_element.chemical_composition
        self.other_edit_init_values['Orbit Type'] = self.parent_item.solar_system_element.orbit_type


class SatelliteDetailsDialog(PlanetDetailsDialog):

    def _set_unit_labels(self):
        sse: Satellite = self.parent_item.solar_system_element
        super()._set_unit_labels()
...
class TrojanSatelliteDetailsDialog(SatelliteDetailsDialog):
    ...
    def _set_line_edits(self):
        sse: TrojanSatellite = self.parent_item.solar_system_element
        super()._set_line_edits()
...
class TrojanDetailsDialog(PlanetDetailsDialog):
    ...
    def _set_line_edits(self):
        sse: Trojans = self.parent_item.solar_system_element
        super()._set_line_edits()
...
class AsteroidBeltDetailsDialog(PlanetDetailsDialog):
    ...
    def _set_line_edits(self):
        sse: AsteroidBelt = self.parent_item.solar_system_element
        super()._set_line_edits()
