...
For a :ref:`trojan satellite <trojan_satellite>`, the habitability conditions are the same as the
...
4. The :ref:`trojan satellite's <trojan_satellite>` grandparent must have a viable relaxed :ref:`HZ <habitable_zones>`.
5. The :ref:`semi-major axis <semi_major_axis>` must be within the relaxed :ref:`HZ <habitable_zones>` of the grandparent.
6. The orbit of the parent must be :ref:`stable <orbital_stability>`.
