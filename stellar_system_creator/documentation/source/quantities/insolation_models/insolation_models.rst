...
as well as the climate of the target :ref:`habitable <habitability>` world.
We use insolation for a specific climate to normalize the
:ref:`luminosity <luminosity>` of a :ref:`star's <star>`,
and then try and estimate the threshold at which distance from
the :ref:`star's <star>` these environmental situations occur.
