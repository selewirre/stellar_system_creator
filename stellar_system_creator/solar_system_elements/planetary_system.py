...
from stellar_system_creator.solar_system_elements.stellar_body import Planet, Satellite, Trojans
...
class PlanetarySystem:
    ...
    def __init__(self, name, parent: Union[Planet, BinarySystem] = None,
                 ...
                 trojans_list: List[Trojans] = None) -> None:
    ...
    def add_trojan(self, trojan: Trojans):
        self.trojans_list.append(trojan)

    def add_trojans(self, trojans: List[Trojans]):
