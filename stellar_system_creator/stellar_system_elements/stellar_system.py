...
<<<<<<<< HEAD:stellar_system_creator/stellar_system_elements/stellar_system.py
...
>>>>>>>> Small bug fixes and refractions.:stellar_system_creator/solar_system_elements/solar_system.py
...
class StellarSystem:
    ...
    def __init__(self, name, parent: Union[Star, BinarySystem] = None,
        ...
        self.want_draw_stellar_system_limits = True
    ...
    def draw_stellar_system(self, save_fig=False, save_name=None, save_format='pdf', save_temp_file=None):
        ...
        if self.want_draw_stellar_system_limits:
            self.draw_stellar_system_limits()
    ...
    def draw_stellar_system_limits(self):
